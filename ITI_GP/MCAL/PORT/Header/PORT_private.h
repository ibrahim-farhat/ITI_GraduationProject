 ...
 * @file PORT_private.h
 * @author Ibrahim Tarek
 * @brief This file contains PORT module private defines.
 * @version 1.00
 */
...
/*PORTX_PINY_DIR Options*/
#define INPUT		0
#define OUTPUT		1

/*PORTX_PINY_INITIAL_VALUE Options*/
#define FLOATING			0
#define INTERNAL_PULL_UP	1
#define LOW					0
#define HIGH				1

/*Functions like macro to concatenate the configurations of pins*/
#define CONC(b7,b6,b5,b4,b3,b2,b1,b0)			CONC_HELPER(b7,b6,b5,b4,b3,b2,b1,b0)
#define	CONC_HELPER(b7,b6,b5,b4,b3,b2,b1,b0)	0b##b7##b6##b5##b4##b3##b2##b1##b0

/*Macro to carry initial directions of ports*/
...
/*Macro to carry initial values of ports*/
